...
function simpleParameterDecorator(originalMethod, _context) {
    return function () {
        var args = [];
...
var ExampleClass = function () {
    ...
    return _a = /** @class */ (function () {
            ...
            ExampleClass.prototype.someMethod = function (param1, param2) {
        ...
        (function () {
            ...
            _someMethod_decorators = [simpleParameterDecorator];
